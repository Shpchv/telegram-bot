...
bot = telebot.TeleBot("put your token here", parse_mode='html')
...
def send_welcome(message):
    ...
    bot.send_message(message.chat.id, "привет,меня зовут NAME, я твой polaroid фотограф. я хочу предоставить тебе возможность сохранить твои самые любимые фотокарточки не только в пикселях, но и на бумаге.", reply_markup=markup)
